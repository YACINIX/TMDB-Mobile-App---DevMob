...
export default function Movies() {
  ...
  const loader = useMemo(() => {
    if (cat === "now") return getMoviesNowPlaying;
    if (cat === "popular") return getMoviesPopular;
    if (cat === "top") return getMoviesTopRated;
  ...
  async function onSearch() {
    const q = query.trim();
    if (!q) {
      // si vide -> revenir aux catégories
